...
| Maligne Premium Cruise | **2 h**, adults 16+, includes Pincushion Bay and **30 min** near Spirit Island. | Reference only; the selected itinerary is locked to the booked Classic 12:00 PM sailing, so Premium is not an active decision. | https://www.banffjaspercollection.com/attractions/maligne-lake-cruise/experience/ |
